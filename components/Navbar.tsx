...
export function Navbar({ onOpenConsultation }: NavbarProps) {
  ...
  return (
    <header className="sticky top-0 z-40 w-full shadow-xs">
      ...
      <aside
        aria-label="FCA Regulatory Notice"
        className="w-full bg-[#F8F5EF] text-[#252525] py-2 px-4 text-xs md:text-sm tracking-wide border-b border-[#CDAB7D]/40"
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
          ...
          <div className="hidden lg:flex items-center gap-6 text-xs text-[#5F5F5F]">
            ...
            <a
              href="mailto:anandrathiwealth@rathi.com"
              className="hover:text-[#B3742D] transition-colors text-[#5F5F5F]"
            >
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <div className="hidden sm:flex items-center gap-4">
            ...
            >
              <span>Request Private Introduction</span>
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full bg-[#B3742D] hover:bg-[#7C4C21] text-[#FFFFFF] font-semibold py-3 rounded-sm transition-colors text-center text-sm shadow-xs cursor-pointer"
                >
